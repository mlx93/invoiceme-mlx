# **InvoiceMe - 5-Minute Demo Script**
...
**Demonstrates**: Core InvoiceMe.md requirements + 2 standout features
...
### **3:00-3:45 - Recurring Invoices**
**Narration**: *"FloodShield stores the customer's furniture during reconstruction. I'll set up monthly recurring billing."*

**Actions**:
- Navigate to Recurring Invoices → Create Template
- Customer: Riverside Apartments
- Frequency: Monthly
- Line item: "Monthly Storage Fee" - $450
- Auto-Send: ✓ Enabled
- Click "Create Template"
- **Show**: Template status: Active, Next invoice date: 30 days
- Click "Generate Now" (simulate scheduled job)
- **Show**: New invoice INV-2025-0003 auto-created, status = Sent
- **Show**: Email automatically sent to customer
- **Highlight**: *"Scheduled job runs daily, auto-generates invoices. Event-driven architecture."*

### **3:45-4:15 - Refund Processing**
...
- [ ] Admin portal logged in (admin@floodshield.com)
...
- **Recurring invoices** → Extra feature (not in requirements)
...
**Show Late Fees:**
- Navigate to invoice, manually change due date to 31 days ago
- Run scheduled job
- Show late fee line item added ($125)
- Show overdue status badge (red)
...
- *"Generated on-demand using iText library. In production, we'd cache in AWS S3 with invoice ID as key. For demo, generated in-memory and served directly."*
