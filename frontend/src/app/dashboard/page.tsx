          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {metrics ? formatCurrency(metrics.totalRevenueMTD.amount) : '$0.00'}
              </div>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics ? metrics.outstandingInvoicesCount : 0}</div>
              <p className="text-xs text-gray-500">
                {metrics ? formatCurrency(metrics.outstandingInvoicesAmount.amount) : '$0.00'}
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics ? metrics.overdueInvoicesCount : 0}</div>
              <p className="text-xs text-gray-500">
                {metrics ? formatCurrency(metrics.overdueInvoicesAmount.amount) : '$0.00'}
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics ? metrics.activeCustomers : 0}</div>
            </CardContent>
          </Card>
        </div>
